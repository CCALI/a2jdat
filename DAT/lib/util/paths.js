...
module.exports = {
  ...
  getGuideDirPath(username, guideId, fileDataUrl) {
    ...
    return fileDataUrl ? path.join(this.normalizeFileDataUrl(fileDataUrl)) : path.join(guidesDir, username, 'guides', `Guide${guideId}`);
  },
  ...
  getTemplatesPath({ username, guideId, fileDataUrl }) {
    ...
    const templatesPath = fileDataUrl ? path.join(this.normalizeFileDataUrl(fileDataUrl), 'templates.json') : path.join(guidesDir, username, 'guides', `Guide${guideId}`, 'templates.json');
