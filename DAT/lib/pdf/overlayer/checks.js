...
const checkLibrary = [icon('normal-check', ''), icon('normal-cross', ''), icon('hollow-circle', ''), icon('check-circle', ''), icon('solid-circle', ''), icon('hollow-square', ''), icon('check-square', ''), icon('solid-square', '')];
