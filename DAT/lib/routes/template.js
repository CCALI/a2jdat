...
module.exports = {
  ...
  get(comboId, params, callback) {
    ...
    usernamePromise.then(username => paths.getTemplatePath({
      username,
      guideId,
      templateId,
      fileDataUrl
  ...
  create(data, params, callback) {
    ...
    const templateDataPromise = usernamePromise.then(username => templates.getTemplatesJSON({
      username,
      guideId: data.guideId
    })).then(templatesData => this.getNextTemplateId({ templateIds: templatesData.templateIds })).then(templateId => _.assign(data, {
      templateId,
    ...
    const templatesPathPromise = usernamePromise.then(username => paths.getTemplatesPath({
      username,
      guideId: data.guideId
    }));
  ...
  update(comboId, data, params, callback) {
    ...
    Q.all([writeTemplatePromise]).then(([data]) => this.successHandler({
